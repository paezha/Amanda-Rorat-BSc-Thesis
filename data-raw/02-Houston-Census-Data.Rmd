...
ggscatter(houston_tracts_df, x = "black_prop", y = "area", add = "reg.line", shape = 19, size = 1, xlab = "Proportion of Black Population in Census Tract", ylab = "Area of Walkshed in Square Meters", font.label = c(5, "plain", "black")) +
  stat_cor(label.x = 0.75, label.y = 1800000) #label placement
```

```{r}
ggscatter(houston_tracts_df, x = "black_prop", y = "area", add = "reg.line", shape = 19, size = 1, xlab = "Proportion of White Population in Census Tract", ylab = "Area of Walkshed in Square Meters", font.label = c(5, "plain", "black")) +
  stat_cor(label.x = 0.75, label.y = 1800000) #label placement
```
...
ggscatter(houston_tracts_df, x = "income", y = "area", add = "reg.line", shape = 19, size = 1, xlab = "Average Income in Census Tract", ylab = "Area of Walkshed in Square Meters", font.label = c(5, "plain", "black")) +
  stat_cor(label.x = 110000, label.y = 1800000) #label placement
```
