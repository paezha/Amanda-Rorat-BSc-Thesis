...
```{r}
ggscatter(jacksonville_tracts_df, x = "income", y = "area", add = "reg.line", shape = 19, size = 1, xlab = "Average Income in Census Tract", ylab = "Area of Walkshed in Square Meters", xlim = c(0, 155000)) +
